...
class Config:
    ...
    server_lr: float = 0.3             # ↓ 0.5→0.3: smaller batches → more steps → larger deltas per round
    ...
    server_momentum: float = 0.7       # ↓ 0.9→0.7: fewer artifacts with smaller batch / more steps
